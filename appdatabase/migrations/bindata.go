...
func _1618412233_add_processed_to_metricsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1618412233_add_processed_to_metrics.up.sql", size: 54, mode: os.FileMode(0644), modTime: time.Unix(1623331303, 0)}
...
func _1618571271_add_id_to_app_metricsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1618571271_add_id_to_app_metrics.up.sql", size: 611, mode: os.FileMode(0644), modTime: time.Unix(1623332649, 0)}
