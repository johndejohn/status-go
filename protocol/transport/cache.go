...
func (c *MessageCache) Hits(ids []string) (map[string]bool, error) {
...
func (c *MessageCache) Add(ids []string, timestamp uint64) (err error) {
	var tx *sql.Tx
...
func (c *MessageCache) Clean(timestamp uint64) error {
