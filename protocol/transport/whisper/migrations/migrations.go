...
func _1561059285_add_whisper_keysDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1561059285_add_whisper_keys.down.sql", size: 25, mode: os.FileMode(0644), modTime: time.Unix(1588844135, 0)}
...
func _1561059285_add_whisper_keysUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1561059285_add_whisper_keys.up.sql", size: 112, mode: os.FileMode(0644), modTime: time.Unix(1588844135, 0)}
...
func docGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc.go", size: 373, mode: os.FileMode(0644), modTime: time.Unix(1588844135, 0)}
